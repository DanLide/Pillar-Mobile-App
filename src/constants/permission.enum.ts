 ...
 */
  ...
  * The flag representing the Edit permission for the Subscription sub-module under Administration module.
  */
  ConsultingTools_IML_View = 124,

  /**
   * The flag representing the Delete permission for the Subscription sub-module under Administration module.
   */
  ConsultingTools_IML_Create = 125,

  /**
   * The flag representing the Create permission for the Territories sub-module under Administration module.
   */
  ConsultingTools_IML_Edit = 126,

  /**
   * The flag representing the View permission for the Territories sub-module under Administration module.
   */
  ConsultingTools_IML_Delete = 127,

  /**
   * The flag representing the View permission for the Distributor Profile sub-module under DistributorTools module.
   */
  DistributorTools_DistributorProfile_View = 128,

  /**
   * The flag representing the Edit permission for the Distributor Profile sub-module under DistributorTools module.
   */
  DistributorTools_DistributorProfile_Edit = 129,

  /**
   * The flag representing the Create permission for the Distributor Profile sub-module under DistributorTools module.
   */
  DistributorTools_DistributorProfile_Create = 130,

  /**
   * The flag representing the Delete permission for the Distributor Profile sub-module under DistributorTools module.
   */
  DistributorTools_DistributorProfile_Delete = 131,

  /**
   * The flag representing the View permission for the Territories sub-module under DistributorTools module.
   */
  DistributorTools_Territories_View = 132,

  /**
   * The flag representing the Edit permission for the Territories sub-module under DistributorTools module.
   */
  DistributorTools_Territories_Edit = 133,

  /**
   * The flag representing the Create permission for the Territories sub-module under DistributorTools module.
   */
  DistributorTools_Territories_Create = 134,

  /**
   * The flag representing the Delete permission for the Territories sub-module under DistributorTools module.
   */
  DistributorTools_Territories_Delete = 135,

  /**
   * The flag representing the View permission for the Regions sub-module under DistributorTools module.
   */
  DistributorTools_Regions_View = 136,

  /**
   * The flag representing the Edit permission for the Regions sub-module under DistributorTools module.
   */
  DistributorTools_Regions_Edit = 137,

  /**
   * The flag representing the Create permission for the Regions sub-module under DistributorTools module.
   */
  DistributorTools_Regions_Create = 138,

  /**
   * The flag representing the Delete permission for the Regions sub-module under DistributorTools module.
   */
  DistributorTools_Regions_Delete = 139,
