...
SWIFT_CLASS_NAMED("DBDeviceAuditEvent")
@interface DBDeviceAuditEvent : NSManagedObject
...
@interface DBDeviceAuditEvent (SWIFT_EXTENSION(MLBluetooth))
@property (nonatomic, copy) NSString * _Nullable data;
@property (nonatomic) int16_t dataLength;
@property (nonatomic, copy) NSString * _Nullable deviceIdentifier;
@property (nonatomic) int32_t firmwareCounter;
@property (nonatomic) int32_t firstEventIndex;
@property (nonatomic) int32_t logCounter;
@property (nonatomic, copy) NSString * _Nullable region;
@property (nonatomic) int16_t type;
@end


SWIFT_CLASS_NAMED("DBEncounterEvent")
@interface DBEncounterEvent : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end



@interface DBEncounterEvent (SWIFT_EXTENSION(MLBluetooth))
@property (nonatomic, copy) NSString * _Nullable deviceIdentifier;
@property (nonatomic, copy) NSDate * _Nullable encounteredOn;
@property (nonatomic) int32_t latitude;
@property (nonatomic) int32_t longitude;
@end


SWIFT_CLASS_NAMED("DBVirtualAuditEvent")
@interface DBVirtualAuditEvent : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end



@interface DBVirtualAuditEvent (SWIFT_EXTENSION(MLBluetooth))
@property (nonatomic, copy) NSString * _Nullable data;
@property (nonatomic, copy) NSString * _Nullable deviceIdentifier;
@property (nonatomic, copy) NSDate * _Nullable occurredOn;
@property (nonatomic) int16_t type;
@end
...
SWIFT_CLASS("_TtC11MLBluetooth15LocationService")
...
SWIFT_CLASS("_TtC11MLBluetooth18LockInteractionDAO")
@interface LockInteractionDAO : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC11MLBluetooth11LockScanner")
@interface LockScanner : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface LockScanner (SWIFT_EXTENSION(MLBluetooth)) <CBPeripheralDelegate>
...
@interface LockScanner (SWIFT_EXTENSION(MLBluetooth)) <CBCentralManagerDelegate>
...
///
- (void)readSecondaryPasscodeAtIndex:(NSInteger)index completion:(void (^ _Nonnull)(NSArray<NSString *> * _Nullable, NSError * _Nullable))completion SWIFT_DEPRECATED_MSG("This function uses zero-based indexing to reference a secondary code. This conflicts with Android's implementation which uses one-based indexing. In order to ensure uniformity between platforms, this is being deprecated.\n\nPlease switch to:\nreadSecondaryPasscode(atOneBasedIndex:completion:)");
...
/// \param completion A completion triggered after the lock disconnects from the mobile device.
///
- (void)writeSecondaryPasscodeWithPasscode:(NSArray<NSString *> * _Nonnull)passcode atIndex:(NSInteger)index completion:(void (^ _Nonnull)(NSError * _Nullable))completion SWIFT_DEPRECATED_MSG("This function uses zero-based indexing to reference a secondary code. This conflicts with Android's implementation which uses one-based indexing. In order to ensure uniformity between platforms, this is being deprecated.\n\nPlease switch to:\nwrite(secondaryPasscode:atOneBasedIndex:completion:)");
/// Queue a clear secondary passcode command.
/// \param index An index representing the slot of the secondary code to clear.
///
/// \param completion A completion triggered after the lock disconnects from the mobile device.
///
- (void)clearSecondaryPasscodeWithIndex:(NSInteger)index completion:(void (^ _Nonnull)(NSError * _Nullable))completion SWIFT_DEPRECATED_MSG("This function uses zero-based indexing to reference a secondary code. This conflicts with Android's implementation which uses one-based indexing. In order to ensure uniformity between platforms, this is being deprecated.\n\nPlease switch to:\nclearSecondaryPasscode(atOneBasedIndex:completion:)");
...
///
- (void)unlockWithOption:(enum MLUnlockOptions)option completion:(void (^ _Nonnull)(NSError * _Nullable))completion SWIFT_DEPRECATED_MSG("Please switch to: unlock(mechanism:completion:). This new function will enable state tracking via the MLProductDelegate's product(:didChange:) method. It also does not require that a separate disconnect be queued - this will occur automatically.");
/// Queue an unlock command. The product does not perform the unlock until Bluetooth has been disconnected. <em>Clients shall use the disconnect command to trigger this immediately.</em>
/// \param option An enumeration specifying which shackle/door to unlock.
///
...
/// \param completion A completion block triggered with the response data or an error.
///
- (void)unlockWithOption:(enum MLUnlockOptions)option seconds:(NSInteger)seconds completion:(void (^ _Nonnull)(NSError * _Nullable))completion SWIFT_DEPRECATED_MSG("Please switch to: unlock(mechanism:seconds:completion:). This new function will enable state tracking via the MLProductDelegate's product(:didChange:) method. It also does not require that a separate disconnect be queued - this will occur automatically.");
...
/// \param completion A completion triggered after the lock disconnects from the mobile device.
///
- (void)writeRelockTimeWithRelockTime:(NSInteger)relockTime completion:(void (^ _Nonnull)(NSError * _Nullable))completion SWIFT_DEPRECATED_MSG("Please switch to write(relockTime:completion:)");
/// Queue a write memory command to write a primary passcode to the product.
/// \param passcode The passcode to write to the product.
///
/// \param completion A completion triggered after the lock disconnects from the mobile device.
///
- (void)writePrimaryPasscodeWithPasscode:(NSArray<NSString *> * _Nonnull)passcode completion:(void (^ _Nonnull)(NSError * _Nullable))completion SWIFT_DEPRECATED_MSG("Please switch to write(primaryPasscode:completion:)");
@end
...
/// \param payload A base64 encoded string to write to the lock. This must come from Master Lock’s Connected Products Web API.
///
/// \param completion A completion triggered after the lock disconnects from the mobile device.
///
...
/// A class representing an <code>MLProduct</code>’s temperature reading.
SWIFT_CLASS("_TtC11MLBluetooth13MLTemperature")
@interface MLTemperature : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
